...
const LotteryList = () => {
  ...
  const handleARLotteryPlay = () => {
    console.log("Playing AR Lottery");
  };
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-900 to-gray-800 py-12 overflow-x-hidden">
      <div className="w-full px-4">
        {/* Centered header section with adjusted margin */}
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="text-center max-w-4xl mx-auto mb-12 mt-8" // Added mt-8 to lower the text
        >
        ...
        {/* AR Lottery section with fixed colors */}
        <motion.div
                ...
                >
                  <div className="relative p-6">
                    ...
                    <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-md p-6 rounded-lg relative z-10 border border-white border-opacity-20">
                      ...
                      <motion.div
                        className="bg-gray-900 bg-opacity-40 p-4 rounded-lg mb-5 border border-gray-500 border-opacity-30"
                        initial={{ opacity: 0.9 }}
                        animate={{
                          opacity: [0.9, 1, 0.9],
                          scale: [1, 1.02, 1],
